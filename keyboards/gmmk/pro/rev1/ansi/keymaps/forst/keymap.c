...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [L_FUNC] = LAYOUT(
        ...
        UG_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_SYRQ,
        XXXXXXX, XXXXXXX, UG_VALU, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,          XXXXXXX,
        XXXXXXX, UG_HUED, UG_VALD, UG_HUEU, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX,          XXXXXXX,
        _______,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, NK_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          _______, UG_NEXT, XXXXXXX,
        _______, _______, _______,                            XXXXXXX,                            _______, _______, _______, UG_SPDD, UG_PREV, UG_SPDU
    )
};
// clang-format on
...
// RGB
    ...
    bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
        if (layer_state_is(L_FUNC)) {
            ...
            // SysReq
            RGB_MATRIX_SET_HSV_OBEY_BRIGHTNESS(PIN_DEL, HSV_RED);

            // RGB control
            RGB_MATRIX_SET_HSV_OBEY_BRIGHTNESS(PIN_GRAVE, HSV_WHITE);
